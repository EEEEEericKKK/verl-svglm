...
export WANDB_PROJECT=verl-geo3k-rlvr
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2.5-7b_function_rm-geo3k-sgl-multi-w-tool-verify-n16' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.test_freq=20 \
    data.train_files=/proj/inf-scaling/csl/svglm/data/geo3k_multiturn_rl/train.parquet \
    data.val_files=/proj/inf-scaling/csl/svglm/data/geo3k_multiturn_rl/test.parquet \

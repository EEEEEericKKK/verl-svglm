...
# Model configuration
MODEL_PATH="${MODEL_PATH:-/proj/inf-scaling/csl/svglm/LlamaFactory/saves/qwen3-vl-8b/full/sft_mathcanvas}"
...
OUTPUT_PATH="${OUTPUT_PATH:-/proj/inf-scaling/csl/svglm/verl/outputs/inference/Mathcanvas-qwen3-sft.jsonl}"

...
export MODEL_PATH="/proj/inf-scaling/csl/svglm/checkpoints/verl_sft_geo3k/geo3k-qwen3-vl-8b-instruct_v1_merged/global_step_1746"
# export MODEL_PATH="Qwen/Qwen3-VL-8B-Instruct"
export DATA_PATH="/proj/inf-scaling/csl/svglm/data/mathcanvas.parquet"
export IMAGE_FOLDER="/proj/inf-scaling/csl/svglm/data/geo3k_toolcall"
export OUTPUT_PATH="/proj/inf-scaling/csl/svglm/verl/outputs/inference/mathcanvas_sft-from-geo3k.jsonl"
export NUM_SAMPLES=""
